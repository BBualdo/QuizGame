...
public static class DummyData
{
    ...
    public static List<Answer> GetAnswers()
    {
        var answers = new List<Answer>
        {
            ...
            new Answer { AnswerId = 33, Name = "299,792,458 m/s", IsCorrect = true, QuestionId = 10 },
            new Answer { AnswerId = 34, Name = "150,000,000 m/s", IsCorrect = false, QuestionId = 10 },
            new Answer { AnswerId = 35, Name = "1,080,000,000 km/h", IsCorrect = false, QuestionId = 10 },
            new Answer { AnswerId = 36, Name = "100,000 km/s", IsCorrect = false, QuestionId = 10 },
            // Answers for History Questions
            new Answer { AnswerId = 37, Name = "George Washington", IsCorrect = true, QuestionId = 11 },
            new Answer { AnswerId = 38, Name = "Thomas Jefferson", IsCorrect = false, QuestionId = 11 },
            new Answer { AnswerId = 39, Name = "Abraham Lincoln", IsCorrect = false, QuestionId = 11 },
            new Answer { AnswerId = 40, Name = "John Adams", IsCorrect = false, QuestionId = 11 },
            new Answer { AnswerId = 41, Name = "1912", IsCorrect = true, QuestionId = 12 },
            new Answer { AnswerId = 42, Name = "1905", IsCorrect = false, QuestionId = 12 },
            new Answer { AnswerId = 43, Name = "1898", IsCorrect = false, QuestionId = 12 },
            new Answer { AnswerId = 44, Name = "1920", IsCorrect = false, QuestionId = 12 },
            new Answer { AnswerId = 45, Name = "Christopher Columbus", IsCorrect = true, QuestionId = 13 },
            new Answer { AnswerId = 46, Name = "Ferdinand Magellan", IsCorrect = false, QuestionId = 13 },
            new Answer { AnswerId = 47, Name = "Marco Polo", IsCorrect = false, QuestionId = 13 },
            new Answer { AnswerId = 48, Name = "James Cook", IsCorrect = false, QuestionId = 13 },
            new Answer { AnswerId = 49, Name = "Neil Armstrong", IsCorrect = true, QuestionId = 14 },
            new Answer { AnswerId = 50, Name = "Buzz Aldrin", IsCorrect = false, QuestionId = 14 },
            new Answer { AnswerId = 51, Name = "Yuri Gagarin", IsCorrect = false, QuestionId = 14 },
            new Answer { AnswerId = 52, Name = "Michael Collins", IsCorrect = false, QuestionId = 14 },
            new Answer { AnswerId = 53, Name = "American Civil War", IsCorrect = true, QuestionId = 15 },
            new Answer { AnswerId = 54, Name = "World War I", IsCorrect = false, QuestionId = 15 },
            new Answer { AnswerId = 55, Name = "World War II", IsCorrect = false, QuestionId = 15 },
            new Answer { AnswerId = 56, Name = "Spanish-American War", IsCorrect = false, QuestionId = 15 },
            // Answers for Geography Questions
            new Answer { AnswerId = 57, Name = "Nile River", IsCorrect = true, QuestionId = 16 },
            new Answer { AnswerId = 58, Name = "Amazon River", IsCorrect = false, QuestionId = 16 },
            new Answer { AnswerId = 59, Name = "Yangtze River", IsCorrect = false, QuestionId = 16 },
            new Answer { AnswerId = 60, Name = "Mississippi River", IsCorrect = false, QuestionId = 16 },
            new Answer { AnswerId = 61, Name = "Asia", IsCorrect = true, QuestionId = 17 },
            new Answer { AnswerId = 62, Name = "Africa", IsCorrect = false, QuestionId = 17 },
            new Answer { AnswerId = 63, Name = "North America", IsCorrect = false, QuestionId = 17 },
            new Answer { AnswerId = 64, Name = "Europe", IsCorrect = false, QuestionId = 17 },
            new Answer { AnswerId = 65, Name = "China", IsCorrect = true, QuestionId = 18 },
            new Answer { AnswerId = 66, Name = "India", IsCorrect = false, QuestionId = 18 },
            new Answer { AnswerId = 67, Name = "USA", IsCorrect = false, QuestionId = 18 },
            new Answer { AnswerId = 68, Name = "Indonesia", IsCorrect = false, QuestionId = 18 },
            new Answer { AnswerId = 69, Name = "Australia", IsCorrect = true, QuestionId = 19 },
            new Answer { AnswerId = 70, Name = "Europe", IsCorrect = false, QuestionId = 19 },
            new Answer { AnswerId = 71, Name = "South America", IsCorrect = false, QuestionId = 19 },
            new Answer { AnswerId = 72, Name = "Antarctica", IsCorrect = false, QuestionId = 19 },
            new Answer { AnswerId = 73, Name = "Sweden", IsCorrect = true, QuestionId = 20 },
            new Answer { AnswerId = 74, Name = "Finland", IsCorrect = false, QuestionId = 20 },
            new Answer { AnswerId = 75, Name = "Norway", IsCorrect = false, QuestionId = 20 },
            new Answer { AnswerId = 76, Name = "Canada", IsCorrect = false, QuestionId = 20 },
            // Answers for Math Questions
            new Answer { AnswerId = 77, Name = "3.14", IsCorrect = true, QuestionId = 21 },
            new Answer { AnswerId = 78, Name = "2.71", IsCorrect = false, QuestionId = 21 },
            new Answer { AnswerId = 79, Name = "1.62", IsCorrect = false, QuestionId = 21 },
            new Answer { AnswerId = 80, Name = "0", IsCorrect = false, QuestionId = 21 },
            new Answer { AnswerId = 81, Name = "4", IsCorrect = true, QuestionId = 22 },
            new Answer { AnswerId = 82, Name = "3", IsCorrect = false, QuestionId = 22 },
            new Answer { AnswerId = 83, Name = "5", IsCorrect = false, QuestionId = 22 },
            new Answer { AnswerId = 84, Name = "6", IsCorrect = false, QuestionId = 22 },
            new Answer { AnswerId = 85, Name = "4", IsCorrect = true, QuestionId = 23 },
            new Answer { AnswerId = 86, Name = "5", IsCorrect = false, QuestionId = 23 },
            new Answer { AnswerId = 87, Name = "6", IsCorrect = false, QuestionId = 23 },
            new Answer { AnswerId = 88, Name = "7", IsCorrect = false, QuestionId = 23 },
            new Answer { AnswerId = 89, Name = "9.8 m/s^2", IsCorrect = true, QuestionId = 24 },
            new Answer { AnswerId = 90, Name = "3.14 m/s^2", IsCorrect = false, QuestionId = 24 },
            new Answer { AnswerId = 91, Name = "2.71 m/s^2", IsCorrect = false, QuestionId = 24 },
            new Answer { AnswerId = 92, Name = "1.62 m/s^2", IsCorrect = false, QuestionId = 24 },
            new Answer { AnswerId = 93, Name = "2x", IsCorrect = true, QuestionId = 25 },
            new Answer { AnswerId = 94, Name = "x^2", IsCorrect = false, QuestionId = 25 },
            new Answer { AnswerId = 95, Name = "1/x", IsCorrect = false, QuestionId = 25 },
            new Answer { AnswerId = 96, Name = "x", IsCorrect = false, QuestionId = 25 }
        };
        return answers;
    }
}